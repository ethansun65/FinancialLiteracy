...
questions = [
    ...
    "You see a $50 pair of shoes you want — what happens?",
    ...
    "If someone offers you double your money in a month, you think:",
...
options = [
    ...
    ["Save up", "Wait for sale", "Buy today", "Forget it"],
    ...
    ["Too good to be true", "Maybe", "Why not?", "TAKE MY MONEY"],
